...
export default function SchoolReadinessPage() {
  const pdfPath = "/resources/school-readiness-matrix.pdf";
  const citationText =
    "Rodriguez D. School Readiness Matrix, 2025 - First Edition. Sullivan, MO: Windrose & Company; 2025.";
  const shareUrl = "https://ai.windrose.dev/resources/school-readiness-matrix";
